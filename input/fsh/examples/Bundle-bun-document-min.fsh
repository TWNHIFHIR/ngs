...
* entry[0].fullUrl = "https://nhicore.nhi.gov.tw/ngs/Composition/com-min"
* entry[0].resource = com-min

* entry[1].fullUrl = "https://nhicore.nhi.gov.tw/ngs/DiagnosticReport/dia-min"
* entry[1].resource = dia-min

* entry[2].fullUrl = "https://nhicore.nhi.gov.tw/ngs/Condition/con-min"
...
* entry[8].fullUrl = "https://nhicore.nhi.gov.tw/ngs/DocumentReference/doc-gene-min"
* entry[8].resource = doc-gene-min

* entry[9].fullUrl = "https://nhicore.nhi.gov.tw/ngs/Observation/obs-diagnostic-min"
