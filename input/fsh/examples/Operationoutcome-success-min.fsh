...
* issue.details = $NHIOperationOutcome#審畢結果 
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
    ...
    <p><b>問題詳細資訊</b>：審畢結果 <span style=\"background: LightGoldenRodYellow; margin: 4px; border: 1px solid khaki\"> (<a href=\"CodeSystem-nhi-operationoutcome.html\">NHI-系統回應訊息值集</a>#審畢結果)</span></p>
</div>"