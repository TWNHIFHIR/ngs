...
* apply -> "(申請資訊)"
* apply.cancerDrugType -> "entry:MedicationRequest.medicationCodeableConcept（醫令代碼）"
* patient -> "(病人資訊)"
...
* apply -> "(申請項目)"
* apply.cancerDrugType -> "basedOn.reference(MedicationRequest)（醫令代碼）"
...
Source: ApplyModel
Target: "https://twcore.mohw.gov.tw/ig/ngs/StructureDefinition/Observation-ngstype-twngs"
* gene -> "(基因資訊)"
...
* gene.mutationType -> "component.code.coding.code (基因突變類型)"
...
* gene.genTesList -> "component：gen-test-list(檢測基因列表)"
...
* apply -> "(申請項目)"
* apply.cancerDrugType -> "code.coding (基因定序檢測申請品項之醫令代碼)"
