<table class="grid rwd-table" style="background-color:#ffffe6;width: 100%;">
    ...
    <tr>
      ...
      <td><i>Version</i>:<span class="copy-text">1.0.0<button title="" class="btn-copy" data-clipboard-text="https://twcore.mohw.gov.tw/ig/ngs/ImplementationGuide/tw.gov.mohw.nhi.ngs|1.0.0" data-original-title="複製含版本資訊的URL"></button></span></td>
    </tr>
    <tr>
